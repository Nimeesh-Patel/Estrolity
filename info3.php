...
<body>
    ...
    <main class="container">
        <section class="intro-text" style="padding: 0px;">
            <div class="container">
                <h1>Psychology With Spirituality</h1>
                <p style="line-height: 40px">
                    Embark on a transformative journey where psychology meets spirituality. Our platform explores the symbiotic relationship between the mind and the spirit, offering a holistic path to healing and growth. We delve into how psychological principles can be applied within spiritual practices to foster a deeper sense of peace, fulfillment, and interconnectedness. Discover how blending these disciplines can lead to a more balanced, joyful, and meaningful life.
                </p>
            </div>
        </section>
    </main>

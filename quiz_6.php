...
<header>
        ...
        <div class="quiz-container">
            <form action="quiz_6.php" method="post">
                <div class="question">
                    <h3 style="margin-bottom: 30px; margin-top: 10px;">You strive to maintain peace in relationships, even if it means setting aside your own objectives.</h3>
                    <div class="options">
                        <h4 style="margin-top: 20px; color: #32a574;">Agree</h4>
                        <input type="radio" id="option1" name="socialInteraction6" value="1" class="option-circle-1">
                        <label for="option1"></label>
                        <input type="radio" id="option2" name="socialInteraction6" value="2" class="option-circle-2">
                        <label for="option2"></label>
                        <input type="radio" id="option3" name="socialInteraction6" value="3" class="option-circle-3">
                        <label for="option3"></label>
                        <input type="radio" id="option4" name="socialInteraction6" value="4" class="option-circle-4">
                        <label for="option4"></label>
                        <input type="radio" id="option5" name="socialInteraction6" value="5" class="option-circle-5">
                        <label for="option5"></label>
                        <input type="radio" id="option6" name="socialInteraction6" value="6" class="option-circle-6">
                ...
                <div class="progress-container">
                    <div class="progress-bar" id="quizProgress" style="width: 62.5%;"></div>
                </div>
                <div class="d-flex justify-content-between" style="margin: 0 100px; margin-top: 20px;">
                    <button type="button" class="btn btn-previous" onclick="location.href='quiz_5.php'">Previous</button>
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                if (isset($_POST['socialInteraction6'])) {
                    ...
                    header('Location: quiz_7.php'); // Redirect to the next quiz page
                    exit();
                } else {
                    // Store the flash message and redirect back to quiz_6.php
                    $_SESSION['flash_message'] = 'Please choose an option for question 6!';
